...
define('TOKEN', '61e6eb55c4250632645494935285');
...
define('CAMPAIGN_HASH', 'c1cf37d4-1155-454e-8894-877788f35b91');
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    //код пикселя фб записывать в файл confirm.html - найти его в папке, открыть - внести код пикселя
       header('Location: ./confirm.php?name=' .$name .'&phone=' .$phone  .'&clickid=' . $body['response']['content']['click_id'] , true);
